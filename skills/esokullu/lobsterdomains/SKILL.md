...
> **Important:** Save `opensrsUsername` and `opensrsPassword` — these are required for post-purchase DNS and transfer management.
...
Returns up to 50 latest orders with OpenSRS management credentials.
...
6. **Save credentials** — return OpenSRS management details to the user
